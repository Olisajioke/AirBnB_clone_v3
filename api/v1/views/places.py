#!/usr/bin/python3
"""
Module that creates a view for Place objects
"""
...
def bad_request(error):
    """
    function that returns Bad Request message for illegal requests to the API
    """
...
def search_places():
    """
    function that retrieves Place obj based on provided JSON search criteria
    """
